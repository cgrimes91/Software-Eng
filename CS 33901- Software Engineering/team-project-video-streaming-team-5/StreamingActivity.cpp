...
int main(int argc, char* argv[]) {
    ...
    while (getline(invideo, line)) {
        ...
        {
            case Video::MOVIE:
                videos.push_back(new Movie(title, hours, minutes));
            break;
            case Video::TVSHOW:
                videos.push_back(new TVShow(title, hours, minutes, episodes));
            break;
            case Video::ORIGINAL:
                videos.push_back(new Original(title, hours, minutes, episodes));
            break;
        }
    }
    invideo.close();
